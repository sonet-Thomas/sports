            ...
            <div class="slider_section banner_main">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main_text">
                                <h1>Welcome <br><strong class="bold_text"></strong><strong class="bold_text_black"></strong></h1>
                                <span></span>
                                <form action="save.php" method="POST">  
                                <br>USER NAME<input type="text" place holder="enter your name" name="user" style="margin-left:40px"></br><br></br>
                                PASSWORD<input type="pasword" name="pass"style="margin-left:40px"><br></br>
                                <input type="submit" name="submit" value="submit">
                                <input type="submit" name="reg" value="regsitration">
                                <form>  
